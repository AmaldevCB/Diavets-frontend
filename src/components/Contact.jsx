...
return (
    <>
        <div id='Contact' className="scroll-mt-30 my-10 px-[45px] sm:px-[90px] lg:px-[200px] lg:mt-20 flex flex-col sm:flex-row gap-20 lg:gap-10">
                    ...
                    <div>
                        ...
                        <ul className='mt-4 lg:mt-10 space-y-4 lg:space-y-10'>
                            <li className="flex items-center gap-3">
                                ...
                                <span className='hover:text-[#1FAF38]'>+91 9111116483</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <i className="fa-solid fa-envelope text-[#2867B4] text-[18px]"></i>
                                <span className='hover:text-[#1FAF38]'>info@diavets.com</span>
                            </li>
            ...
            <div className="sm:w-1/2 bg-[#EAF5FF] border rounded-lg p-10 lg:pt-6 mt-10 sm:mt-3 lg:mt-0">
                ...
                <form onSubmit={handleSubmit} className="mt-4 lg:mt-8 space-y-3 lg:space-y-[40px] text-[16px] sm:text-[18px] lg:text-[21px] lg:leading-[36px]">
                    ...
                    <button
                        type="submit"
                        className="bg-[#2867B4] lg:text-[21px] text-white text-sm px-4 py-1 rounded mt-2"
                    >
                        Send Messege
                    </button>
                </form>
