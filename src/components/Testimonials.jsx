...
function Testimonials() {
    ...
    return (
        <>
            <div id='Testimonials' className="scroll-mt-25 my-10 container lg:mt-20">
            ...
            <div className="bg-[#F9F9F9]   pb-15">
                ...
                <div className="px-[86px] lg:px-[35%] mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <img src={image[2]?.picture} className='object-contain h-auto sm:h-[80px] sm:w-[250px] md:h-[112px] lg:h-[140px] w-[185px] md:w-[300px] lg:w-[500px]' alt="logo 1" />
                    <img src={image[3]?.picture} className='object-contain h-auto sm:h-[80px] sm:w-[250px] md:h-[112px] lg:h-[140px] w-[185px] md:w-[300px] lg:w-[500px]' alt="logo 2" />
                    <img src={image[4]?.picture} className='object-contain h-auto sm:h-[80px] sm:w-[250px] md:h-[112px] lg:h-[140px] w-[185px] md:w-[300px] lg:w-[500px]' alt="logo 3" />
                </div>
            </div>
        </>
    )
